...
export const getIcon = (iconName) => {
  const icons = {
    ...
    settings: <svg className="w-5 h-5" viewBox="0 b 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6m5.2-13.2l-4.2 4.2m-2 2l-4.2 4.2m13.2-5.2l-4.2-4.2m-2-2l-4.2-4.2"/></svg>,
