        ...
        {requests.map((request) => (
          <div key={request.id} className="bg-white p-4 rounded-lg shadow border border-gray-200">
            <div className="flex justify-between items-start mb-3">
              ...
              <span className={`px-2 py-1 text-xs font-semibold rounded-full border ${getUrgencyColor(request.urgency)}`}>
                {request.urgency}
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <p className="font-bold text-red-600">{request.bloodType}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <span className={`inline-flex text-xs font-semibold rounded-full ${getStatusColor(request.status)} px-2 py-0.5`}>
                  {request.status}
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 pt-3 border-t border-gray-100">
              <Button onClick={() => onView(request)} variant="secondary" className="text-xs px-3 py-1.5 flex-1 justify-center">
                View
              </Button>
                ...
                <>
                  {onNotify && (
                    <button
                      ...
                      className="text-indigo-600 hover:text-indigo-900 bg-indigo-50 hover:bg-indigo-100 p-2 rounded transition-colors flex-1 flex justify-center"
                      title="Notify Donors"
                    >
                  ...
                  <button
                    ...
                    className="text-green-600 hover:text-green-900 bg-green-50 hover:bg-green-100 p-2 rounded transition-colors flex-1 flex justify-center"
                  ...
                  <button
                    ...
                    className="text-gray-600 hover:text-gray-900 bg-gray-50 hover:bg-gray-100 p-2 rounded transition-colors flex-1 flex justify-center"
              ...
              <button
                ...
                className="text-red-600 hover:text-red-900 bg-red-50 hover:bg-red-100 p-2 rounded transition-colors flex-1 flex justify-center"
